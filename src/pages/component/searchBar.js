...
export default function SearchingBar({ searchInput, setSearchInput, url="/api/Searchsubject/", searching, setSearching}) {
    ...
    return (
        <div className="flex gap-2 flex-col ">
            ...
            <input type="search" className="peer bg-gray-50 md:min-w-64 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-400 dark:placeholder-gray-200 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500"
